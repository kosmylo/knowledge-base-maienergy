...
logging.info("Milvus insertion script for INRIA images started.")
...
try:
    ...
    collection.flush()
    logging.info(f"Inserted {len(entries)} INRIA images into Milvus (multimodal embeddings).")
...
logging.info("Milvus insertion script for INRIA images completed.")