...
logging.info("Milvus insertion script for Wikipedia images started.")
...
try:
    ...
    collection.flush()
    logging.info(f"Inserted {len(entries)} Wikipedia images into Milvus (multimodal embeddings).")
...
logging.info("Milvus insertion script for Wikipedia images completed.")