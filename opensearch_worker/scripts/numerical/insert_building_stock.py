...
INDEX_NAME = os.getenv("BUILDING_STOCK_INDEX")
...
# Check and create hybrid index (knn + keyword)
...
# Text splitter setup for the descriptions
...
# Load dataset
csv_file = 'data/numerical/bso/building_stock.csv'
df = pd.read_csv(csv_file).fillna("")

actions = []
for _, row in tqdm(df.iterrows(), total=df.shape[0], desc="Processing Building Stock records"):
